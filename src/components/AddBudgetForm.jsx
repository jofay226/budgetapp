  ...
  return (
    <div className='form-wrapper'>
        ...
        <fetcher.Form method="post" className="grid-sm" ref={formRef}>
            ...
            <button type="submit" className="btn btn--dark" disabled={isSubmitting}>{ isSubmitting ? <span>Submitting...</span> : <> <span>Create budget</span> <CurrencyDollarIcon width={20}/> </>}</button>
        </fetcher.Form>
    </div>
  )
}
